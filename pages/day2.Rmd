...
> 💡
> **In `R`, list elements are accessible with the `$` accessor. Our `dds` object is indeed a list made up of two elements, the `counts` table and the `samples` table, these are accessible using `$` like we did above.** 
