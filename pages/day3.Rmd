...
After having used the main `edgeR` function, we can actively explore the results of the analysis for the comparisons of our interest by using the `topTags()` function.
...
With the gray line we indicate a fold-change of +/- 1 which, if you recall, stands for an **actual change magnitude of 2**.
